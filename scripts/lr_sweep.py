...
# Log-scale LR grid: 1e-4 to 3e-3
SWEEP_LRS = [1e-4, 3e-4, 6e-4, 1e-3, 3e-3]
...
def run_training(extra_args: list[str], dry_run: bool = False):
    cmd = [sys.executable, "-m", "cs336_basics.training_together"] + extra_args
    print("\n" + "=" * 70)
